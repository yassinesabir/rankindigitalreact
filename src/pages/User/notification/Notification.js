...
const Notification = () => {
    ...
    useEffect(() => {
        let fetchLeadsTimeout, fetchSubjectsTimeout;
        ...
        const fetchSubjects = async () => {
            try {
                const response = await axiosInstance.get('/email-subjects');
                setSubjects(response.data);
                toast.success('Sujets récupérés avec succès!');
            } catch (error) {
                console.error('Error fetching subjects:', error);
                fetchSubjectsTimeout = setTimeout(() => {
        ...
        return () => {
            ...
            clearTimeout(fetchSubjectsTimeout);
        };
    }, [axiosInstance]);
